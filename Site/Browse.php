...
<th class="Member" style="width:150px;">Name</th>
...
echo '
<tr class="table-item">
<td style="border-left: 1px solid #cccccc"><a class="roblox-avatar-image" data-user-id="' . $row['id'] . '" data-image-size="custom" data-image-size-x="64" data-image-size-y="64" href="/User.aspx?id=' . $row['id'] . '"><div style="position: relative;"><a href="/User.aspx?id=' . $row['id'] . '"><img title="' . $username . '" alt="' . $username . '" border="0" height="64" width="64" src="https://squared.cf/get_avatar?id=' . $row['id'] . '"></a></td>
<td><img src="' . $online2 . '" alt="' . $username . ' is ' . $online . '" style="border-width:0px;"> <a href="/User.aspx?id=' . $row['id'] . '">' . $username . '</a></td>
<td>' . $blurb . '</td>
<td>' . $jksdaf . '</td>
...
echo'<tr class="GridPager">
        ...
        if($page > 7 || $page == 7) echo"<td><b><a href='/Browse.aspx?page=1&search=" . $search . "'>... </a></b></td>";

        if($page == 1 OR $page == 2 OR $page == 3 OR $page == 4 OR $page == 5) {
        }else{
            echo"<td>
                            <b><a href='/Browse.aspx?page=".$page6."&search=" . $search . "'>".$page6." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$page5."&search=" . $search . "'>".$page5." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$page4."&search=" . $search . "'>".$page4." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$page3."&search=" . $search . "'>".$page3." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$page2."&search=" . $search . "'>".$page2." </a></b>
                        </td>
                    ";
        }
        ...
        if($page == 5) {
            echo"<td>
                            <b><a href='/Browse.aspx?page=".$pager3."&search=" . $search . "'>".$pager3." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$pager2."&search=" . $search . "'>".$pager2." </a></b>
                        </td>
                    <td>
                          <b><a href='/Browse.aspx?page=".$pager1."&search=" . $search . "'>".$pager1." </a></b>
                        </td>
                    <td>
                           <b> <a href='/Browse.aspx?page=".$pager."&search=" . $search . "'>".$pager." </a></b>
                        </td>
                    ";
        }else{
        }
        ...
        if($page == 4) {
            echo"<td>
                            <b><a href='/Browse.aspx?page=".$pagej2."&search=" . $search . "'>".$pagej2." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$pagej1."&search=" . $search . "'>".$pagej1." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$pagej."&search=" . $search . "'>".$pagej." </a></b>
                        </td>
                    ";
        }else{
        }
        ...
        if($page == 3) {
            echo"<td>
                            <b><a href='/Browse.aspx?page=".$pagey1."&search=" . $search . "'>".$pagey1." </a></b>
                        </td>
                    <td>
                            <b><a href='/Browse.aspx?page=".$pagey."&search=" . $search . "'>".$pagey." </a></b>
                        </td>
                    ";
        }else{
        }
        ...
        if($page == 2) {
            echo"<td>
                            <b><a href='/Browse.aspx?page=".$paget."&search=" . $search . "'>".$paget." </a></b>
                        </td>
                    ";
        }else{
        }
        ...
        for ($page<=$pagefix;$page<=$pagefix;$page++) {
            if($pageor == $page){
                ...
                echo "
                        <td>
                            <b><a href='/Browse.aspx?page=".$page."&search=" . $search . "'>".$page." </a></b>
                        </td>
                        ";
            }
        }
echo "
<td><b><a href='/Browse.aspx?page=$numberofpages&search=" . $search . "'>...</a></td></b>
                                    </tr>
                    </tbody></table></td>
        </tr>
