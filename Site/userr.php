...
i dual boot Windows 10 and Solus. I also enjoy me some good Portal, and am just kinda in the OSC and little more.';
   ...
   <body class="">
    ...
    <style type="text/css">
        #Body {
            padding: 10px; background-color: #2B2D31;
        }
    </style>
    <div>
...
<h2 class="title">
    <span id="ctl00_cphRoblox_rbxUserPane_lUserRobloxURL" style="color:#ECECEC;"><?php echo $user; ?>'s Profile</span></h2>
<div class="divider-bottom" style="position: relative;z-index:3;padding-bottom: 20px">
    <div style="width: 100%">
        <div id="ctl00_cphRoblox_rbxUserPane_onlineStatusRow">
            ...
            ?>
            <br>
            <a style="color:#ECECEC;">Role: <?php echo $asd; ?></a>
                <a href="https://squared.cf/user?id=<?php echo $id; ?>"><br>https://squared.cf/user?id=<?php echo $id; ?></a>
            </div>
            <?php 
            if ($banned == 'yes') {
                echo '<br>
...
<div class="UserBlurb" style="margin-top: 10px; overflow-y: auto; max-height: 450px; ">
    <span style="color:#ECECEC;">Join Date: <?php 
    if ($user == 'acroarson') {
        echo '240000000 BC';
    } else {
        echo $aeae;
...
<br>
<br><span style="color:#ECECEC;"><?php echo $about; ?></span>
</div>
...
<h2 class="title">
<span style="color:#ECECEC;">SQUARED Badges</span>
</h2>
	...
	<?php if($adminlevel == "yes"){
		echo'<td>
			    <div class="Badge">
				    ...
				    <div class="BadgeLabel"><a id="ctl00_cphRoblox_rbxUserBadgesPane_dlBadges_ctl00_HyperLink1" style="color:#ECECEC;">Administrator</a></div>
			    </div>
	</td>'; } ?>
	</tr>
</tbody></table>
...
<h2 class="title"><span style="color:#ECECEC;">Statistics</span></h2>

<div class="divider-bottom" style="padding-bottom: 20px">
<table class="statsTable">
    <tbody><tr>
        <td class="statsLabel">
        <acronym title="The number of this user's friends." style="color:#ECECEC;">Friends</acronym>:
        </td>
        <td class="statsValue">
        <span id="ctl00_cphRoblox_rbxUserStatisticsPane_lFriendsStatistics" style="color:#ECECEC;">0</span>
        </td>
    </tr><tr>
        <td class="statsLabel">
        <acronym title="The number of all the user's places visits combined." style = "color:#ECECEC;">Place Visits</acronym>:
        </td>
        <td class="statsValue">
        <span id="ctl00_cphRoblox_rbxUserStatisticsPane_lFriendsStatistics" style="color:#ECECEC;">0</span>
        </td>
        ...
        <td class="statsLabel">
        <acronym title="The number of how many times this profile was shown." style="color:#ECECEC;">Profile Views</acronym>:
        </td>
        <td class="statsValue">
        <span id="ctl00_cphRoblox_rbxUserStatisticsPane_lFriendsStatistics" style="color:#ECECEC;"><?php echo $kkz; ?></span>
        </td>
    </tr>
		...
		<div class="divider-left" style="width: 484px; float: left; position: relative; left: -1px">
            <div class="divider-bottom" style="padding-bottom: 20px; padding-left: 20px">
                <h2 class="title" style="float: left;color:#ECECEC;">
...
<div id="ctl00_cphRoblox_rbxUserPlacesPane_ShowcaseFooter" class="PanelFooter" style="margin-top:5px;margin-left:20px;color:#ECECEC;padding:3px;">
...
<div style="margin: 12px 0 20px; overflow:visible">
    <h2 style="float: left;color:#ECECEC;"><?php echo $user; ?>'s Friends</h2>
...
<div id="UserPlaces" style="overflow: hidden">
<div id="ctl00_cphRoblox_rbxUserPlacesPane_ShowcaseFooter" class="PanelFooter" style="margin-top:5px;margin-left:20px;padding:3px;margin-bottom:18px;color:#ECECEC;">
