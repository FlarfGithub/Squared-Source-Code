...
function skgl()
{
$fdsgdfgfd = array('"Ngjfjjdjdfjjfjfjfjfjfjfjjggjggjgjgj" - NeX', '"on 10/23/2021 the database had a seizure, a stroke, and a heart attack simultaneously" - acro', '"fartticklepiss" - AkZ', '"hacked by banana" - Banana', '"Cats are cats." - krypto', '"alert(<span class="hljs-string">"Hi"</span>);" - pos0&nbsp;<span style="color: #808080;"><span style="color: #999999;">(lol pos0 is an idiot he tried to put an alert)</span></span>', '"xороший" - Ale1', '"Calvy is being worked on, please wait until we come back soon." - Iaceon', '"Yo mama Joke compliation 2016 - 2020" - TheCoolestPerson', '"Ye" - masterofdoomedballs', '"aaaakjd" - Zlarb', '"my balls itch" - Flanger', '"Fuck Fuck Cum Bars" - troll', '"i do best" - sudoapt', '"pablo escobar was a good man" - pablo', '"I smear my ass with Vaseline, and I love anal sex so much" - NickMarkick&nbsp;<span style="color: #999999;">(hes so fucking gay i swear)</span>', '"I am pro" - Bizzziez', '"i love cats" - kqm', '"i have no idea what is happening to the website" - mentum', '"why the fuck is slovakian music so good" - charlie', '"Lego Island Is Awesome" - PepperRoni', '"Fuck my femboy ass~" - Cross', '"i luv u banana" - natan', '"fwdasmfdcnsoam+" - Miguel');
$rand_keys = array_rand($fdsgdfgfd, 2);
echo $fdsgdfgfd[$rand_keys[0]] . "\n";
}

    function undermaintenance($reason, $ass)
    {
        ?>
		<title>Instandhaltung</title>
		<center><h1>Entschuldigung, wir befinden uns in Wartungsarbeiten.</h1></center>
		<center><h2><?php echo($ass); ?></h2></center>
		<center><h2>check back later</h2></center>
		<center><h4><?php echo($reason); ?></h4></center>
        <?php
    }
    ...
    function quotes()
    {
		...
		<center>"fwdasmfdcnsoam+" - Miguel</center>
		<center></center>
		<center></center>
		<center></center>
		<center></center>
...
<div class="wrapper">
    ...
    function buildnavassets()
    {
        ...
        <ul class="nav nav-pills nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/admin/assets/shirts">Shirts</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/admin/assets/pants">Pants</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/admin/assets/tshirts">T-Shirts</a>
            </li>
        </ul>
        <?php
    }
    ...
    function buildnavadmin()
    {
        ...
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/admin/users">Users</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/admin/games">Games</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/admin/assets">Assets</a>
            </li>
        </ul>
        <?php
    }

    function buildnavcatalog()
    {
        ?>
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/catalog/hats">Hats</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/catalog/faces">Faces</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/catalog/shirts">Shirts</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/catalog/pants">Pants</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/catalog/tshirts">T-Shirts</a>
            </li>
        </ul>
        <?php
    }

    function buildnavavatar()
    {
        ?>
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/avatar/hats">Hats</a>
            </li><li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/avatar/faces">Faces</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/avatar/shirts">Shirts</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/avatar/pants">Pants</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/home/avatar/tshirts">T-Shirts</a>
            </li>
        </ul>
        <?php
    }
        ...
        ?>
            ...
            <div class="footer" style="clear:both;width:100%; border-top: 1px solid grey;">
                <div class="card-body">
                    ...
                    <p class="card-text">Balls is not sponsored, authorized or endorsed by ROBLOX</p>
                </div>
            </div>
        <?php
    }
